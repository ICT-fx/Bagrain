 ...
 * en 3:4 dans `public/img/team/` et affichées dans leurs couleurs d'origine —
 * le format commun suffit à en faire une série. Celle d'Olivier est en noir et
 * blanc. Un visage sans photo retombe sur ses initiales.
 */

const PORTRAITS: Record<string, string> = {
  "Lola Bembekoff": "/img/team/lola-bembekoff.jpg",
  "Paul Duteil": "/img/team/paul-duteil-2.jpg",
  "Stéphane Bembekoff": "/img/team/stephane-bembekoff-6.jpg",
                      ...
                      {portrait ? (
                        <>
                          ...
                          <Image
                            ...
                            /* Couleurs d'origine : chaque photo garde la
                               lumière où elle a été prise. Celle d'Olivier est
                               en noir et blanc, et c'est très bien ainsi. */
